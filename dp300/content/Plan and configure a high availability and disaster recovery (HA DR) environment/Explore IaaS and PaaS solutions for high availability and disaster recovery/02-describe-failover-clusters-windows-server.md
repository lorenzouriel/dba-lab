...
To learn more about how multi-subnet works on FCI, see [SQL Server Multi-Subnet Clustering (SQL Server)](https://learn.microsoft.com/en-us/sql/sql-server/failover-clusters/windows/sql-server-multi-subnet-clustering-sql-server).
...
To learn how to configure a distributed network name for FCI, see [Configure a DNN for failover cluster instance](https://learn.microsoft.com/en-us/azure/azure-sql/virtual-machines/windows/failover-cluster-instance-distributed-network-name-dnn-configure).
