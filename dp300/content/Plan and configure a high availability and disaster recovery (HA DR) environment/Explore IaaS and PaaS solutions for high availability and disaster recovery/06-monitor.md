...
System Center provides management packs to monitor Azure SQL Managed Instance and Azure SQL Database. See the [management pack documentation](https://learn.microsoft.com/en-us/system-center/scom/azure-sql-management-pack-management-pack-delivery) for requirements and details.
