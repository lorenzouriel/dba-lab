...
*(Screenshot: Azure monitor displaying logical disk performance, CPU Utilization, and Available memory.)*
...
*(Screenshot: SQL VM resource provider.)*
...
*(Screenshot: directions to register with SQL IaaS Agent Extension.)*
...
*(Screenshot: native Performance Monitor displaying the reporting interface, with a single counter being collected.)*
