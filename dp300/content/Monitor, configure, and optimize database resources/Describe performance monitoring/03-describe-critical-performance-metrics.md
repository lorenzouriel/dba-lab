...
*(Screenshot: the alert page on Azure portal)*
...
*(Screenshot: the alert page for a Virtual Machine)*
...
*(Screenshot: the alert logic features on configure signal logic page)*
...
*(Screenshot: where the create action group option is located when creating a new alert)*
...
*(Screenshot: add action group page when creating a new alert)*
...
*(Screenshot: email/SMS message/push/voice page used for notification preferences when creating a new alert)*
...
*(Screenshot: the metrics dashboard where you can filter by different time range)*
