...
*(Screenshot: Extended Event running on a SQL Database)*
...
For more information about extended events on Azure SQL Database, see [Extended events in Azure SQL Database](https://learn.microsoft.com/en-us/azure/azure-sql/database/xevent-db-diff-from-svr).
...
*(Screenshot: Creating an Extended Events Session)*
...
*(Screenshot: Event selection in SQL Server Management Studio)*
...
*(Screenshot: Global event selection)*
...
*(Screenshot: Event filter in SQL Server Management Studio)*
