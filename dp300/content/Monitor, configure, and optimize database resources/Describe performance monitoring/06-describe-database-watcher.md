...
*(Diagram: database watcher components and data flow from monitored resources to watcher to data store to Azure portal dashboards.)*

Database watcher requires a data store for the monitoring data it collects. You can use a database on an [Azure Data Explorer](https://learn.microsoft.com/en-us/azure/data-explorer/data-explorer-overview) cluster or on a free Azure Data Explorer cluster or you can use a [Real-Time Intelligence](https://learn.microsoft.com/en-us/fabric/real-time-intelligence/overview) database in Microsoft Fabric.
...
To learn more about database watcher, see [Quickstart: Create a database watcher to monitor Azure SQL](https://learn.microsoft.com/en-us/azure/azure-sql/database-watcher-quickstart).
