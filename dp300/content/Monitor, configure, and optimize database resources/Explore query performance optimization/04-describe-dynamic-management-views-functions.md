...
To learn about queries to monitor server and database performance, see [Monitoring Microsoft Azure SQL Database and Azure SQL Managed Instance performance using dynamic management views](/en-us/azure/azure-sql/database/monitoring-with-dmvs).
