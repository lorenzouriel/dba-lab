...
For more information about how to monitor blocking, see [Understand and resolve SQL Server blocking problems](/en-us/troubleshoot/sql/performance/understand-resolve-blocking).
