...
To learn more about query hints, see [Hints (Transact-SQL)](/en-us/sql/t-sql/queries/hints-transact-sql-query).

## Query Store hints

[Query Store hints](/en-us/sql/relational-databases/performance/query-store-hints) provides a simple method for shaping query plans without modifying application code.
...
For more information about Query Store hints, see [Query Store hints](/en-us/sql/relational-databases/performance/query-store-hints).
