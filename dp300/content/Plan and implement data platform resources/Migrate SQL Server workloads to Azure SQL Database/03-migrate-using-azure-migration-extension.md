...
![Screenshot of the monitoring page in Azure Database Migration Services in Azure portal.](../../wwl-data-ai/migrate-sql-workloads-azure-sql-databases/media/3-database-migration-service-azure-portal.png)
