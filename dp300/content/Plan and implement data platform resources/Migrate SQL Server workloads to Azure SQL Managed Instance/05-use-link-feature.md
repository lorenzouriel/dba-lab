...
![Diagram showing the replication of databases from the primary replica to the secondary replica through the distributed availability group (AG).](../../wwl-data-ai/migrate-sql-workloads-azure-managed-instances/media/module-2-sql-managed-instance-link-feature.png)
...
- Replicate a database by using [Azure SQL Managed Instance link wizard available in SSMS](/en-us/azure/azure-sql/managed-instance/managed-instance-link-use-ssms-to-replicate-database).
- Replicate a database by using [T-SQL and PowerShell scripts.](/en-us/azure/azure-sql/managed-instance/managed-instance-link-use-scripts-to-replicate-database)
...
For the full list of supported features, see [Limitations of Azure SQL Managed Instance link](/en-us/azure/azure-sql/managed-instance/managed-instance-link-feature-overview?#limitations).
