...
For detailed guidance on migrating SQL Server databases to Azure SQL Managed Instance using Azure Arc, see [Migration to Azure SQL Managed Instance](/en-us/sql/sql-server/azure-arc/migrate-to-azure-sql-managed-instance).
