...
- [What is Azure SQL Managed Instance?](/en-us/azure/sql-database/sql-database-managed-instance?azure-portal=true)
- [Migrate SQL Server workloads to Azure SQL Database](/en-us/training/modules/migrate-sql-workloads-azure-sql-databases/?azure-portal=true)
- [Tutorial: Migrate SQL Server to an Azure SQL Managed Instance online using DMS (classic)](/en-us/azure/dms/tutorial-sql-server-managed-instance-online?azure-portal=true)
