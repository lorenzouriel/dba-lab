...
![Diagram showing the hyperscale architecture for Azure SQL Database.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-36.png)
...
![Illustration showing the Hyperscale model.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-37.png)
...
- **Access Management** is provided through the following authentication methods to verify user identity:
  ...
  Azure SQL Database Hyperscale also supports [Row-Level Security (RLS)](https://learn.microsoft.com/en-us/sql/relational-databases/security/row-level-security?azure-portal=true), allowing customers to control access to specific rows in a database table based on user characteristics, such as group membership or execution context.
...
1. Under **Compute + storage**, select the **Configure database** link.
   ...
   ![Screenshot showing how to configure an Azure SQL Database with the hyperscale tier.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-14.png)
2. For **Service tier**, select **Hyperscale**.

   ![Screenshot showing how to select the Hyperscale service tier.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-40_1.png)
