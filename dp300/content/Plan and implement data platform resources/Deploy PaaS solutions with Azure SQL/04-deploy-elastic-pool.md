...
![Screenshot showing the elastic pool page in Azure portal.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-17.png)

## Adding a database to an existing pool

1. Using the Azure portal, locate the pool to which you're adding a database.

   ![Screenshot showing how to add a database to an Elastic Pool in Azure portal.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-18.png)
2. Select **+ Add databases** to add your database to the pool, then select **Apply**.

   ![Screenshot showing how to select a database to add to an elastic pool.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-20.png)
...
![Screenshot showing the resource utilization page of an elastic pool.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-21.png)
...
![Utilization per database in an Elastic Pool from the Azure portal.](../../wwl-data-ai/deploy-paas-solutions-with-azure-sql/media/module-22-plan-implement-final-23.png)
