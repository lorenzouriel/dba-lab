...
You can also take advantage of using a [user-assigned managed identity (UMI)](https://learn.microsoft.com/en-us/azure/azure-sql/database/authentication-azure-ad-user-assigned-managed-identity) with customer-managed keys for TDE, which:
