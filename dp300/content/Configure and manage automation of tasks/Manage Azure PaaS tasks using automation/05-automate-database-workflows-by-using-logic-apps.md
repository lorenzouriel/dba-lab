...
- **Consumption workflows in multi-tenant Azure Logic Apps**: This connector is available only as a managed connector. For more information, review the [managed SQL Server connector operations](https://learn.microsoft.com/en-us/connectors/sql/?azure-portal=true) page.
