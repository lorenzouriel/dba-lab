...
If you're proficient in SQL Server, you're likely familiar with the capabilities of the [SQL Server Agent](https://learn.microsoft.com/en-us/ssms/agent/sql-server-agent?azure-portal=true). SQL Server Agent is also available on Azure SQL Managed Instance. However, if you're using Azure SQL Database, you'll need an alternative scheduling mechanism, as both the `msdb` database and the SQL Server Agent are unavailable.
