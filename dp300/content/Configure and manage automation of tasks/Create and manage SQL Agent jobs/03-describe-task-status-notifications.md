...
![Screenshot showing how to enable mail profile in the SQL Server Agent properties.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-08.png)
...
![Screenshot showing how to assign a notification recipient for job failures.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-09.png)
...
![Screenshot showing how to create an alert.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-10.png)
