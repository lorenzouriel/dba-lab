...
It's crucial to understand the importance of backups, as well as index and statistics maintenance, for all your databases. Database consistency checks, also known as [CHECKDB](https://learn.microsoft.com/en-us/sql/t-sql/database-console-commands/dbcc-checkdb-transact-sql?azure-portal=true) (using the command `DBCC CHECKDB`), are equally important because they are the only way to check an entire database for corruption. Depending on the size of your databases and your uptime requirements, you might perform all these activities nightly. However, in production systems, maintenance operations are often spread out over the week, as both index maintenance and consistency checks are very I/O intensive and typically done during weekend hours.
...
![Screenshot showing the Maintenance Plan Wizard screen.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-04.png)
...
![Screenshot showing the job schedule in SQL Agent.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-05.png)
...
![Screenshot showing the maintenance tasks avaialble on the maintenance plan wizard.](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-06.png)
...
![Complete Maintenance Plan in SSMS](../../wwl-data-ai/schedule-tasks-using-sql-server-agent/media/module-66-automation-final-07.png)
