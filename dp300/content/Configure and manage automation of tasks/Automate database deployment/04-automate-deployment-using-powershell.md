...
To learn more about the full list of command-names for the Az.Sql module, see [Azure PowerShell Az.Sql](https://learn.microsoft.com/en-us/powershell/module/az.sql).
