...
Diagram showing a repository folder structure with a .github folder containing copilot-instructions.md and a prompts subfolder with .prompt.md files.
...
Next unit: Connect to MCP server endpoints, including Microsoft SQL Server and Fabric lakehouse
