...
// dp800/content/ lesson file the answer/explanation comes from.
const DP800_QUESTIONS = [
{
  "id": "easy-01",
  "tier": "easy",
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Design and implement database objects with SQL/02-understand-your-sql-server-based-platform-choices.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Design and implement database objects with SQL/04-optimize-with-indexes.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/02-create-views.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/03-apply-window-functions-for-analytics.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/04-process-json-data-with-built-in-functions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/02-describe-ai-assisted-development-tools.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/06-create-and-configure-github-copilot-instruction-files.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Design and implement database objects with SQL/06-enforce-data-integrity-with-constraints.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/07-choose-when-to-use-each-option.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/02-organize-queries-with-common-table-expressions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/08-compare-rows-with-correlated-subqueries.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/03-interpret-security-impact-of-using-ai-assisted-tools.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Design and implement database objects with SQL/05-use-specialized-table-types.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/06-create-triggers.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/05-match-patterns-with-regular-expressions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/09-handle-errors-with-try-catch.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/07-traverse-relationships-with-graph-queries.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/04-enable-github-copilot-and-fabric-copilot.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Write advanced T-SQL code/06-find-approximate-matches-with-fuzzy-string-functions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/05-configure-model-and-mcp-tool-options.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement RAG with SQL/02-identify-rag-use-cases-architecture.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement RAG with SQL/03-prepare-retrieval-context-augmentation.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement RAG with SQL/05-generate-process-rag-responses.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement intelligent search with SQL/04-prepare-sql-vector-search.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement intelligent search with SQL/06-implement-hybrid-search-ranking.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement intelligent search with SQL/02-choose-intelligent-search-approach.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement intelligent search with SQL/03-implement-full-text-search.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement intelligent search with SQL/05-implement-vector-search-query-patterns.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement models and embeddings with SQL/03-create-manage-external-model-sql.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement models and embeddings with SQL/04-design-embeddings-sql-database-workloads.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement models and embeddings with SQL/05-generate-maintain-embeddings-sql-database-workloads.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement models and embeddings with SQL/02-understand-evaluate-models-sql-database-workloads.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/02-create-build-validate-sql-database-projects.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/03-configure-source-control-manage-reference-data.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/02-design-implement-data-encryption.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/03-design-implement-dynamic-data-masking.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/02-create-configuration-files-data-api-builder.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/03-define-entities-rest-graphql.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Optimize database performance/02-recommend-database-configurations.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Optimize database performance/04-evaluate-query-performance.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/04-manage-branching-pull-requests-conflict-resolution.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/05-detect-resolve-schema-drift.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/04-design-implement-row-level-security.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/05-design-implement-object-level-permissions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/04-expose-database-objects-stored-procedures-views.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/07-handle-changes-event-driven-patterns.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Optimize database performance/03-preserve-data-integrity-isolation-levels.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/07-design-implement-testing-strategy.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/06-implement-auditing.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/08-secure-graphql-rest-mcp-endpoints.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/05-deploy-data-api-builder-azure-services.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Optimize database performance/05-monitor-tune-queries-query-store.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Optimize database performance/06-identify-resolve-blocking-deadlocks.md",
    "heading": "Deadlocks",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement CI CD by using SQL database projects/06-implement-cicd-pipelines.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Implement data security and compliance with SQL/07-secure-model-endpoints.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Design and implement database objects with SQL/03-build-effective-tables.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/03-create-stored-procedures.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/04-create-scalar-functions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement programmability objects with SQL/05-create-table-valued-functions.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Design and develop database solutions/Implement SQL solutions by using AI-assisted tools/07-connect-to-mcp-server-endpoints.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Implement AI capabilities in database solutions/Design and implement RAG with SQL/04-augment-prompts-database-context.md",
...
},
{
  ...
  "source": {
    "path": "dp800/content/Secure, optimize, and deploy database solutions/Integrate SQL solutions with Azure services/06-recommend-azure-monitor-configurations.md",
