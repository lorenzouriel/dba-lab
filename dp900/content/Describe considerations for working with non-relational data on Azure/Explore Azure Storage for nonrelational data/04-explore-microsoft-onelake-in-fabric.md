...
- **Easy to navigate** It's straightforward to navigate OneLake data from Windows using [OneLake file explorer](https://learn.microsoft.com/en-us/fabric/onelake/onelake-file-explorer).
