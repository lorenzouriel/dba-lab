...
![Screenshot of a table of sales quantities per product and text card showing total revenue.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/text-table.png)
...
![Screenshot of a column chart showing revenue per category for each city.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/bar-column-chart.png)

Bar and column charts are a good way to visually compare numeric values for discrete categories.

## Line charts

![Screenshot of a line chart showing revenue trend over time for each product category.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/line-chart.png)
...
![Screenshot of a pie chart showing proportion of sales by product category.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/pie-chart.png)

Pie charts are often used in business reports to visually compare categorized values as proportions of a total.

## Scatter plots

![Screenshot of a scatter plot showing marketing spend vs revenue.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/scatter-plot.png)
...
![Screenshot of a map showing comparative revenue by city.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/map.png)
...
![Screenshot of a report in Power BI Desktop, with visualizations filtered based on a selected city.](../../wwl-data-ai/explore-fundamentals-data-visualization/media/power-bi-report.png)
