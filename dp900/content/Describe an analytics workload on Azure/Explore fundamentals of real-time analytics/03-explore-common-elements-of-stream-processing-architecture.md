...
![Diagram of a general stream processing architecture showing events flowing through a source queue, a perpetual query processor, and into a sink.](../../wwl-data-ai/explore-fundamentals-stream-processing/media/stream-processing-architecture.png)
