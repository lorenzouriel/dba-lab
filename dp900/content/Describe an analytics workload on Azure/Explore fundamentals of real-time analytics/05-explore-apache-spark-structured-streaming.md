...
![Diagram of streaming data flowing from a source into a dataframe, being queried, and written to a sink.](../../wwl-data-ai/explore-fundamentals-stream-processing/media/spark-structured-streaming.png)
...
> **Note**
>
> For more information about Delta Lake, see [Lakehouse and Delta Lake tables.](https://learn.microsoft.com/en-us/fabric/data-engineering/lakehouse-and-delta-tables)
