...
![Diagram showing a relational database schema.](../../wwl-data-ai/explore-core-data-concepts/media/relational-keys-sql.png)
...
![Diagram showing a key-value database.](../../wwl-data-ai/explore-core-data-concepts/media/key-value-store.png)
...
![Diagram showing a document database.](../../wwl-data-ai/explore-core-data-concepts/media/document-store.png)
...
![Diagram showing a column family database.](../../wwl-data-ai/explore-core-data-concepts/media/column-family-store.png)

- **Graph databases**, which store entities as nodes with links to define relationships between them.

![Diagram showing a graph database.](../../wwl-data-ai/explore-core-data-concepts/media/graph.png)
